...
\SubBulletItem
\textbf{Project:}
% China Department of Science and Technology Key Grant 2023YFE0204300, focused on Breast Cancer, 
...
\begin{Detail}
    \SubBulletItem
    1 \textbf{Patent} Application Specification; in Progress.
    \SubBulletItem
    1 \textbf{Medical Device} Specification; in Progress.
\end{Detail}
...
\Section
{{\large Language Proficiency}}
{{\large Language Proficiency}}
{PDF:Language Proficiency}
