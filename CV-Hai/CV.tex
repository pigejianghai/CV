...
experiments design, paper writing and Tensorflow framework.
\SubBulletItem
\textbf{Publication:}
...
\SubBulletItem
\textbf{Experience and Skills:}
Numerical experiments, mathematical equations proof, Deep Learning, programming. 
Reproduced the mathematical iteration equations in C++, Python and PyTorch.
\end{Detail}
