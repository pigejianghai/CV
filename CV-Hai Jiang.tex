...
specializing in \textbf{Physiological-Model-Based AI for the Recovery Monitoring of Elderly after Hip Fracture Surgery}. 
...
Your focus on multi-modal model-based signal processing, 
sensing and physiological system modeling techniques in the healthcare field 
aligns closely with my research interests. 
I am particularly passionate about advancing multi-modal data analysis and 
developing innovative algorithms address the challenges of healthcare applications 
using cutting-edge digital health monitoring technologies. 
