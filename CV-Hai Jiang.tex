...
Your focus on advancing the next generation of human-centered AI systems and facilitating their broad societal 
impact aligns closely with my research interests. 
I am particularly passionate about foundational AI research, 
with a focus on machine learning, automated reasoning, and optimization. 
My goal is to design AI algorithms and systems that enhance performance and robustness 
while lowering the expertise required to effectively utilize AI techniques. 
My interdisciplinary background, programming expertise, and research experience 
uniquely position me to excel in and contribute meaningfully to the challenges and rigor of this PhD opportunity.
...
The interdisciplinary nature of your research and team, along with the expertise and accomplishments of its members, 
aligns perfectly with my academic and professional aspirations. 
This position represents an ideal next step toward achieving my goals. 
I am eager to join an environment that fosters intellectual rigor, 
collaboration, and access to the resources necessary to realize my ambitions.
...
\section{\textbf{Research Experience}}%, Sun Yat-sen University}
	...
	\cvline{\textbf{\small{Task Focus}}}{Placenta Accreta Spectrum Disorders, T2-WI MRI, Prenatal Diagnosis, Multi-class classification.}
	...
	\cvline{\textbf{\small{Task Focus}}}{Breast Cancer, Dual-Energy CT, Sentinel Lymph Nodes, Metestatic status, Multi-class classification.}
...
\clearpage
\addcontentsline{toc}{section}{\textbf{publications}}
% \nocite{1,2}
\nocite{*}
\bibliographystyle{plain}
% \begin{lstlisting}
	\begin{thebibliography}{99}
		...
		\bibitem[2]{} 
					Jiawei Pan, Zilong He, Yue Li, Weixiong Zeng, Yaya Guo, Lixuan Jia and Hai Jiang et. al. 
