...
specializing in \textbf{AI to combine and model ElectroMagnetic Noise Footprint (EMNFs) in cables}. 
...
The focus of this PhD position—integrating electronics and AI for medical electronic equipment, specifically embedding AI technologies into the design to address electromagnetic interference in medical devices—closely aligns with my research interests. 
I am particularly passionate about developing a structural understanding of 
the exchange of parasitic energy between cables and their environment using AI tools, 
as well as exploring methods to combine multiple electromagnetic noise footprints effectively. 
