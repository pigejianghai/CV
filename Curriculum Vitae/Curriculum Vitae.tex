...
\section{\textbf{Research Experience}}%, Sun Yat-sen University}
	...
	\cvline{$\bullet$}{Published: “Anatomy-Guided Multitask Learning for MRI-Based Classification of Placenta Accreta Spectrum and Its Subtypes” (Accepted at ISBI 2025).}
...
% \section{\textbf{Research Experience I}, Nankai University}
	...
	\cvline{$\bullet$}{Reproduced iterative mathematical equations from “Deep ADMM-Net for Compressed-Sensing MRI” using C++, Python, and PyTorch.}
	% \cvline{\textbf{\small{Supervisors}}}{Prof.~Chunlin~Wu, Prof.~Yunhua~Xue}
	\cvline{\textbf{\small{Skills}}}{Reproduced iterative mathematical equations from “Deep ADMM-Net for Compressed-Sensing MRI” using C++, Python, and PyTorch.}
	% \cvline{\textbf{\small{Experience and Skills}}}
	...
	\cvline{$\bullet$}{Implemented the ROF model from “Nonlinear Total Variation Based Noise Removal Algorithms” using C++ and Python.}
